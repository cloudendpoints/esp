...
class TestStartEsp(unittest.TestCase):
    nginx_conf_template = "./src/nginx/main/nginx-conf-template"
    server_conf_template = "./src/nginx/main/server-conf-template"
    generated_nginx_config_file = "./src/nginx/main/nginx.conf"
    generated_server_config_file = "./src/nginx/main/generated_server_configuration.json"
    basic_config_generator = "./src/nginx/main/start_esp_binary --generate_config_file_only --pid_file ./src/nginx/main/pid_file --service_account_key key --config_dir ./src/nginx/main --template ./src/nginx/main/nginx-conf-template --server_config_template ./src/nginx/main/server-conf-template --service_json_path ./src/nginx/main/testdata/test_service_config_1.json --server_config_generation_path ./src/nginx/main/generated_server_configuration.json"
    ...
    def test_basic_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_basic_nginx.conf"
    ...
    def test_backend_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_backend_nginx.conf"
    ...
    def test_underscores_in_headers_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_underscores_in_headers_nginx.conf"
    ...
    def test_enable_websocket_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_enable_websocket_nginx.conf"
    ...
    def test_client_max_body_size_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_client_max_body_size_nginx.conf"
    ...
    def test_client_body_buffer_size_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_client_body_buffer_size_nginx.conf"
    ...
    def test_allow_invalid_headers_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_allow_invalid_headers_nginx.conf"
    ...
    def test_worker_processes_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_worker_processes_nginx.conf"
        config_generator = self.basic_config_generator + " --worker_processes 1234"
        self.run_test_with_expectation(expected_config_file, self.generated_nginx_config_file, config_generator)

    def test_ssl_protocols_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_ssl_protocols_nginx.conf"
    ...
    def test_ssl_port_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_ssl_port_nginx.conf"
    ...
    def test_basic_cors_preset_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_preset_basic_nginx.conf"
        config_generator = self.basic_config_generator + " --cors_preset basic"
        self.run_test_with_expectation(expected_config_file, self.generated_nginx_config_file, config_generator)

    def test_cors_allow_origin_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_allow_origin_nginx.conf"
    ...
    def test_cors_allow_methods_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_allow_methods_nginx.conf"
    ...
    def test_cors_allow_headers_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_allow_headers_nginx.conf"
    ...
    def test_cors_allow_credentials_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_allow_credentials_nginx.conf"
    ...
    def test_cors_expose_headers_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_expose_headers_nginx.conf"
    ...
    def test_cors_allow_origin_regex_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cors_allow_origin_regex_nginx.conf"
    ...
    def test_service_control_url_override_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_service_control_url_override_server.json"
    ...
    def test_rollout_strategy_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_rollout_strategy_server.json"
    ...
    def test_client_ip_header_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_client_ip_header_server.json"
    ...
    def test_client_ip_position_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_client_ip_position_server.json"
    ...
    def test_management_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_management_server.json"
    ...
    def test_transcoding_always_print_primitive_fields_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_transcoding_always_print_primitive_fields_server.json"
    ...
    def test_rewrite_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_rewrite_server.json"
    ...
    def test_disable_cloud_trace_auto_sampling_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_disable_cloud_trace_auto_sampling_server.json"
    ...
    def test_cloud_trace_url_override_arg_output_is_as_expected(self):
        expected_config_file = "./src/nginx/main/testdata/expected_cloud_trace_url_override_server.json"
